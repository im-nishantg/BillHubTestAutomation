...
import com.billhub.qa.pages.InvoiceValidationByTaxation_1022_BT_Page;
...
public class InvoiceValidationByTaxation_1022_BT_Test extends TestBase{

	LoginPage loginPage;
	InvoiceValidationByTaxation_1022_BT_Page invoiceValidationPage;
	public Object[][] data;

	public InvoiceValidationByTaxation_1022_BT_Test() {
		super();
	}
	...
	public void setup(){
		...
		invoiceValidationPage = new InvoiceValidationByTaxation_1022_BT_Page();
