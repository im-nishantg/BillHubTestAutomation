...
import com.billhub.qa.pages.InvoiceValidationByTaxation_MERU_Page;
import com.billhub.qa.pages.LoginPage;
import com.billhub.qa.utils.TestUtils;


public class InvoiceValidationByTaxation_MERU_Test extends TestBase{
	
	LoginPage loginPage;
	InvoiceValidationByTaxation_MERU_Page invoiceValidationPage;
	public Object[][] data = TestUtils.getTestData("InvoiceValidationAccounts_MERU");
	
	public InvoiceValidationByTaxation_MERU_Test() {
		super();
	}
	...
	public void setup(){
		...
		loginPage.loginAsTaxation(prop.getProperty("taxation_loginid_MERU"),prop.getProperty("taxation_password_MERU"));
		invoiceValidationPage = new InvoiceValidationByTaxation_MERU_Page();
	}
