...
import com.billhub.qa.pages.CreatePaymentRequestForNonPOPage;
...
public class CreatePaymentRequestForNonPOPageTest extends TestBase{
	
	LoginPage loginPage;
	CreatePaymentRequestForNonPOPage createPaymentRequestPage;
    Object[][] data;
    ...
    public void setup(){
        ...
        createPaymentRequestPage = new CreatePaymentRequestForNonPOPage();
        data = TestUtils.getTestData("CreatePaymentRequestForNonPo");
    }
    ...
    public void ValidateDownloadPaymentRequestTest()  {
    	...
    	data = TestUtils.getTestData("CreatePaymentRequestForNonPo");			// to get the updated request number
    	String request_number = (String) data[0][3];
