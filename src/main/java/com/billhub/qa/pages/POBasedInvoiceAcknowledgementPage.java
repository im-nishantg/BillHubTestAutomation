...
public class POBasedInvoiceAcknowledgementPage extends TestBase{
	...
	public void readDocumentNumberForValidation() {
    	...
    	WebElement RENumber = TestUtils.waitForElementVisibility(By.xpath("/html/body/modal-container/div/div/app-invoice-info-popup/div[2]/div[1]/div/div/div[2]/div[3]/div[4]/div[2]"));
    	String document_number = RENumber.getText();
    	
    	TestUtils.setCellData("InvoiceValidationAccounts_1022", 1, 3, document_number);		// updating excel sheet
    	TestUtils.setCellData("CreatePaymentRequestForPo", 1, 1, document_number);		
    	TestUtils.setCellData("CreatePaymentRequestForPo", 1, 2, invoice_number);	
	}
